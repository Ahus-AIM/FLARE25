...
def compute_edt(error_component):
    ...
    ] = error_component[min_coords[0] : max_coords[0], min_coords[1] : max_coords[1], min_coords[2] : max_coords[2]]
    ...
    dist_full[min_coords[0] : max_coords[0], min_coords[1] : max_coords[1], min_coords[2] : max_coords[2]] = (
        dist_cropped
    )
...
parser.add_argument(
    "-val_gts",
    "--validation_gts_path",
    default="3D_val_gt_interactive_seg",
    type=str,
...
if not os.path.exists(validation_gts_path):
    ...
    print(
        "[WARNING] Validation path does not exist for your GT data! Make sure you supplied the correct path or your .npz inputs have a gts key!"
    )
