...
# Only added type annotations compared to CVPR25_iter_eval


def compute_multi_class_dsc(gt: Integer[np.ndarray, "D H W"], seg: Integer[np.ndarray, "D H W"]) -> np.floating:
    dsc = []
