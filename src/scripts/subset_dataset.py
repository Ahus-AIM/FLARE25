...
def copy_random_files(src_folder, dst_folder, num_files=10):
...
def main(args):
    ...
    copy_random_files(src_folder, dst_folder, num_files)


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Copy a random subset of files from one directory to another.")
    parser.add_argument("src_folder", type=str, help="Source folder containing files.")
    parser.add_argument("dst_folder", type=str, help="Destination folder to copy files to.")
    parser.add_argument("--num_files", type=int, default=10, help="Number of random files to copy.")
